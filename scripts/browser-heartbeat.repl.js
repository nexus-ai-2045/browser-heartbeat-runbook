...
const attentionSignals = [
  ...
  { needle: "permission required", severity: "medium", category: "user-action" },
  { needle: "permission denied", severity: "high", category: "access" },
  { needle: "grant permission", severity: "medium", category: "user-action" },
  { needle: "grant access", severity: "medium", category: "user-action" },
  { needle: "allow access", severity: "medium", category: "user-action" },
